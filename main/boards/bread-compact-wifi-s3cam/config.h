...
// SD Card configuration (SDSPI mode)
// Sử dụng SPI2_HOST cho SD card (SPI3 đã dùng cho màn hình)
// Nối dây module SD card theo chân bên dưới:
//   MOSI -> GPIO14,  MISO -> GPIO3,  SCLK -> GPIO46,  CS -> GPIO43
...
#define SDCARD_SPI_MOSI                 GPIO_NUM_14
#endif
#ifndef SDCARD_SPI_MISO
#define SDCARD_SPI_MISO                 GPIO_NUM_3
#endif
#ifndef SDCARD_SPI_SCLK
#define SDCARD_SPI_SCLK                 GPIO_NUM_46
#endif
#ifndef SDCARD_SPI_CS
#define SDCARD_SPI_CS                   GPIO_NUM_43
#endif
