...
private:
    ...
    LcdDisplay* display_;
    Esp32Camera* camera_;
    CameraWebServer* camera_web_server_;
    ...
    void InitializeCameraWebServer() {
        camera_web_server_ = new CameraWebServer();
        camera_web_server_->Start(80);
        ESP_LOGI(TAG, "Camera web server started on port 80");
    }
